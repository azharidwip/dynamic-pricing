...
def calculate_dynamic_pricing(df, group_cols):
    ...
    # Batasi multiplier agar tidak lebih dari 1.05 (5% kenaikan maksimum - disesuaikan)
    max_increase = 1.05
...
if __name__ == "__main__":
    ...
    print("Feature engineering completed. Processed DataFrame:")
